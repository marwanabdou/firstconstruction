import { apple, bill, google, sabbour, building, stoneresidence } from "../assets";
...
const Billing = () => (
  ...
  <div className="flex items-center justify-center w-full h-full py-24 sm:py-8 px-4 mt-10">
                      ...
                      <div id="slider" className="h-full flex lg:gap-8 md:gap-6 gap-14 items-center justify-start transition ease-out duration-700">
                          <Slide index={0}>
                              <div className="flex flex-shrink-0 relative w-full sm:w-auto">
                                  ...
                                  <a href={stoneresidence} target="_blank" rel="noopener noreferrer" className="lg:text-xl leading-4 text-base lg:leading-5 text-white">Residential</a>
                                  <a href={stoneresidence} target="_blank" rel="noopener noreferrer" className="py-4 px-6 font-poppins font-medium text-[12px] text-primary bg-transparent outline hover:outline-solid rounded-[10px] ml-5">View</a>
                                      <div className="flex h-full items-end pb-6">
                                          <h3 className="text-xl lg:text-2xl font-semibold leading-5 lg:leading-6 text-white">Stone Residence</h3>
                                      </div>
                                  </div>
                              </div>
                          </Slide>
                          ...
                          <Slide index={2}>
                              <div className="flex flex-shrink-0 relative w-full sm:w-auto">
                                  ...
                                  <div className="bg-gray-800 bg-opacity-30 absolute w-full h-full p-6">
                                      <h2 className="lg:text-xl leading-4 text-base lg:leading-5 text-white">Commercial</h2>
                                      
                                      <div className="flex h-full items-end pb-6">
                                          <h3 className="text-xl lg:text-2xl font-semibold leading-5 lg:leading-6 text-white">Shajaret Al Durr</h3>
                                      </div>
                                  </div>
                              </div>
                          </Slide>
